...
Alternatively, you can just get a copy of it and copy the <tt>redmine_ultraviolet</tt>
directory into <tt>vendor/plugins/</tt>
...
* Originally by Chris Gahan ({epitron}[http://github.com/epitron/]) (2009-2011)
* Contributions by Andy Bailey ({neosonic}[http://github.com/neosonic/]) (2010)
* Contributions by Daniel Exner ({DeX77}[http://github.com/epitron/DeX77]) (2011)
* Refactored by Guillaume Perreal ({Adirelle}[http://github.com/Adirelle/]) (2012)
